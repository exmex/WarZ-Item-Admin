...
namespace WarZLocal_Admin
{
    ...
    {
        public static Bitmap getThumb(Bitmap image, Size newSize)
        {
            int tw, th, tx, ty;
            ...
            tx = (newSize.Width - tw) / 2;
            ty = (newSize.Height - th) / 2;

            Bitmap thumb = new Bitmap(newSize.Width, newSize.Height, PixelFormat.Format24bppRgb);
